  ...
  return (
    <main className="min-h-screen flex flex-col">
      ...
      <footer className="py-12 px-4 border-t border-gray-100 bg-white">
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row justify-between items-center space-y-6 md:space-y-0 text-center md:text-right">
          <div>
            <h2 className="font-display text-3xl text-primary mb-2">شهد</h2>
          ...
          <div className="flex items-center space-x-6 space-x-reverse">
            ...
            >
              <span className="ml-2">@shahed.jo</span>
